...
const Login = props => (
  <div className={style.login}>
    <div className={style.logo}>
      <img src={require("images/logo.png")} alt="Kissco Logo"/>
    </div>
    <form className={style.form} onSubmit={props.handleSubmit}>
      <div className={style.row}>
        <input type="text" placeholder="ID" maxLength="20" value={props.usernameValue} onChange={props.handleInputChange} name = "username" />
        <svg>
      ...
      <div className={style.row}>
        <input type="password" placeholder="パスワード" maxLength="20" value={props.passwordValue} onChange={props.handleInputChange} name = "password" />
        <svg>
      ...
      <input type="submit" value="ログイン" className={style.button} />
    </form>
  </div>
);
